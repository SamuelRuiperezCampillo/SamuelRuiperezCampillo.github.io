...
abstract: |-
  ...
  **Methods and results.** We studied n = 160 patients (35% women, 65.0 ± 10.4 years) of whom (i) n = 75 had AF terminated by ablation propensity matched to (ii) n = 75 without AF termination and (iii) n = 10 with AT. All patients had mapping by 64-pole baskets to identify areas of repetitive activity (REACT) to correlate unipolar EGMs in shape over time. Synchronized regions (REACT) were largest in AT, smaller in AF termination, and smallest in non-termination cohorts (0.63 ± 0.15, 0.37 ± 0.22, and 0.22 ± 0.18, P < 0.001). Area under the curve for predicting AF termination in hold-out cohorts was 0.72 ± 0.03. Simulations showed that lower REACT represented greater variability in clinical EGM timing and shape. Unsupervised machine learning of REACT and extensive (50) clinical variables yielded four clusters of increasing risk for AF termination (P < 0.01, χ²), which were more predictive than clinical profiles alone (P < 0.001).
